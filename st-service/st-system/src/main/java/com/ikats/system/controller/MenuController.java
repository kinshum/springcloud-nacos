...
import com.ikats.core.secure.annotation.PreAuth;
...
public class MenuController extends STController {
	...
	public R<List<MenuVO>> routes(STUser user) {
	...
	public R<List<MenuVO>> buttons(STUser user) {
	...
	public R<List<MenuVO>> grantTree(STUser user) {
	...
	public R<List<Kv>> authRoutes(STUser user) {
